    ...
    <div>
        <section class="section">
          ...
          <section class="section doll-wrapper">
            <div class="doll-body">
                <img src="../assets/images/doll.png" class="doll"/>
                <div class="selected-tshirts">
                    <img src="../assets/images/tshirt-generic.png" data-val="8662000" class="tshirt" id="selected-tshirt-0"/>
                    <img src="../assets/images/tshirt-generic.png" data-val="4914000" class="tshirt" id="selected-tshirt-1"/>
                    <img src="../assets/images/tshirt-generic.png" data-val="2018000" class="tshirt" id="selected-tshirt-2"/>
                    <img src="../assets/images/tshirt-generic.png" data-val="2249000" class="tshirt" id="selected-tshirt-3"/>
                </div>
                <div class="selected-jeans">
                    <img src="../assets/images/jeans-generic.png" data-val="8662000" class="jeans" id="selected-jeans-0"/>
                    <img src="../assets/images/jeans-generic.png" data-val="4914000" class="jeans" id="selected-jeans-1"/>
                    <img src="../assets/images/jeans-generic.png" data-val="2018000" class="jeans" id="selected-jeans-2"/>
                    <img src="../assets/images/jeans-generic.png" data-val="2249000" class="jeans" id="selected-jeans-3"/>
                </div>
            </div>
            <div class="clothes-wrapper">
                <div class="tshirts-wrapper">
                    <div data-id="0" class="card tshirt-card">
                      <div class="card-content">
                        <img src="../assets/images/tshirt-generic.png" class="tshirt tshirt-option"/>
                    ...
                    <div data-id="3" class="card tshirt-card">
                      <div class="card-content">
                        <img src="../assets/images/tshirt-generic.png" data-id="3" class="tshirt tshirt-option"/>
                ...
                <div class="jeans-wrapper">
                  <div data-id="0" class="card jeans-card">
                    <div class="card-content">
                      <img src="../assets/images/jeans-generic.png" class="jeans jeans-option"/>
                      <p><span class=" is-6">Source: </span><span class=" is-6 is-bold">India</span></p>
                      <p class="is-6">Water usage:</p>
                      <div class="drop-container">
                        <span class="drop"></span><span class="drop"></span><span class="drop"></span><span class="drop"></span>
